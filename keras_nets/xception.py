...
PRETRAINED_MODELS_URL = 'https://github.com/fchollet/deep-learning-models/releases/download/v0.4/'

TF_WEIGHTS= 'xception_weights_tf_dim_ordering_tf_kernels.h5'
TF_WEIGHTS_NO_TOP = 'xception_weights_tf_dim_ordering_tf_kernels_notop.h5'
