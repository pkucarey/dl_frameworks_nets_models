...
def CaffeNet(include_top=True, weights='imagenet',
          input_tensor=None):
    ...
    if K.image_dim_ordering() == 'th':
        ...
        raise Exception('Invalid dim ordering: ' + str(K.image_dim_ordering()))
...
if __name__ == '__main__':
    model = CaffeNet(include_top=True, weights='imagenet')
