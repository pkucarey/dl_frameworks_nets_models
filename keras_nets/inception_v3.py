...
PRETRAINED_MODELS_PATH = '/home/carey/workspace/pretrained_models/keras/inception_v3/'
PRETRAINED_MODELS_URL = 'https://github.com/fchollet/deep-learning-models/releases/download/v0.2/'

TH_WEIGHTS = 'inception_v3_weights_th_dim_ordering_th_kernels.h5'
TF_WEIGHTS= 'inception_v3_weights_tf_dim_ordering_tf_kernels.h5'
TH_WEIGHTS_NO_TOP = 'inception_v3_weights_th_dim_ordering_th_kernels_notop.h5'
TF_WEIGHTS_NO_TOP = 'inception_v3_weights_tf_dim_ordering_tf_kernels_notop.h5'
